  ...
  try {
    ...
    return new ImageResponse(
      ...
      <div tw="bg-gray-50 flex w-full h-full">
        ...
        <div tw="absolute bottom-10 left-14 flex flex-col">
          <div tw="flex items-center">
            <div tw="flex w-28 h-28 mr-4 rounded-full">
              <span tw="rounded-full">
                <img tw="rounded-full" alt={user?.name || user?.username} src={user?.profilepicture} />
                </span>
                </div>
                <div tw="flex items-center">
                  <div tw="flex flex-col">
                    {
                      user?.name === null ? (
                        <span tw="font-bold text-4xl" style={{ fontWeight: "700" }}>{user?.username}</span>
                      ) : (
                        <div tw="flex flex-col">
                          <span tw="font-bold text-4xl" style={{ fontWeight: "700" }}>{user?.name}</span>
