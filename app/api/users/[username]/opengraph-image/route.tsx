              ...
              <div tw="absolute flex top-10 left-14">
                ...
                <div tw="absolute bottom-10 left-14 flex flex-col">
                      ...
                      <h1 style={
                        {
                          fontWeight: "bold",
                          fontSize: "50px",
                          fontFamily: "sans-serif, system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, 'Noto Sans', 'Liberation Sans', sans-serif"
                        }
                      }>{user?.username}</h1>
                    ) : (
                  ...
                  style={
                    ...
                    { user?.bio && (<p tw="text-xl p-0"> {user?.bio} </p>)}
                      </div>
                    )
                  }
                </div>
