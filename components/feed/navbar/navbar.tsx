                    ...
                    <div className="inline-flex h-10 items-center justify-center rounded-md bg-background p-1 text-muted-foreground w-full">
                         <ScrollArea className="w-full py-2">
                              <div className="inline-flex h-10 items-center justify-center rounded-md p-1 text-muted-foreground bg-transparent gap-2">
                                   ...
                                   <div className={`inline-flex items-center justify-center whitespace-nowrap rounded-sm px-3 py-1.5 text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 ${activeTab == 'foryou' ? 'bg-secondary-foreground shadow-sm text-foreground' : 'bg-muted'}`} onClick={() => {
                                        router.replace('/feed')
                                   }}>
                                        For You
                                   </div>
                                   <div className={`inline-flex items-center justify-center whitespace-nowrap rounded-sm px-3 py-1.5 text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 ${activeTab == 'following' ? 'bg-secondary-foreground shadow-sm text-foreground' : 'bg-muted'}`} onClick={() => {
